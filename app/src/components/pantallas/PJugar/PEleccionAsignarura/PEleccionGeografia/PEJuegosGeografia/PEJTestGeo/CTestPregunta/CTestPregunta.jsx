import '../../../../PEleccionMatematicas/PEJuegosMates/PEJOperaciones/COperacion/COperacion.css'

const LETRAS = ['A', 'B', 'C', 'D']
const OPCION_KEYS = ['opcion_a', 'opcion_b', 'opcion_c', 'opcion_d']

export default function CTestPregunta({ pregunta, respuestaElegida, onElegir }) {
